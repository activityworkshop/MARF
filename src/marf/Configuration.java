...
implements Serializable, Cloneable
{
	...
	/**
	 * ID of the currently trained subject.
	 */
	...
	)
	{
		...
		this.iClusterFormat = piClusterFormat;
	...
	public Configuration(Configuration poConfiguration)
	{
		...
		this.iClusterFormat = oCopy.iClusterFormat;
	...
	public Properties toProperties()
	{
		...
		oProperties.setProperty("marf.module.classification.clusterformat", Integer.toString(this.iClusterFormat));
	...
	/**
	 * @return the iClusterFormat
	 * @since March 2015
	 */
	public int getClusterFormat()
	{
		return iClusterFormat;
	}

	/**
	 * @param piClusterFormat the iClusterFormat to set
	 * @since March 2015
	 */
	public void setClusterFormat(int piClusterFormat)
	{
		this.iClusterFormat = piClusterFormat;
	}
